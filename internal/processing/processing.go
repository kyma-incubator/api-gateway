...
// Run ?
func (f *Factory) Run(ctx context.Context, api *gatewayv2alpha1.APIRule) error {
...
func (f *Factory) getVirtualService(ctx context.Context, api *gatewayv2alpha1.APIRule) (*networkingv1alpha3.VirtualService, error) {
...
func (f *Factory) getAccessRule(ctx context.Context, api *gatewayv2alpha1.APIRule) (*rulev1alpha1.Rule, error) {
...
func (f *Factory) processVS(ctx context.Context, api *gatewayv2alpha1.APIRule, destinationHost string, destinationPort uint32) error {
...
func (f *Factory) processAR(ctx context.Context, api *gatewayv2alpha1.APIRule, config []*rulev1alpha1.Authenticator) error {
